package com.example.developerhaoz.ckwhiteboard.view.widget;
...
public class CheckView extends View {
    ...
    private void initShadowPaint() {
        if (mShadowPaint == null) {
            ...
            // all in dp
            float outerRadius = STROKE_RADIUS + STROKE_WIDTH / 2; // 13dp
            float innerRadius = outerRadius - STROKE_WIDTH; // 10dp
            float gradientRadius = outerRadius + SHADOW_WIDTH; // 19
            float stop0 = (innerRadius - SHADOW_WIDTH) / gradientRadius; // 4/19
            float stop1 = innerRadius / gradientRadius; // 10/19
            float stop2 = outerRadius / gradientRadius; // 13/19
            float stop3 = 1.0f;
